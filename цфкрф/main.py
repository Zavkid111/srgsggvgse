...
class AdminSelectAction(StatesGroup):
...
@dp.message(Registration.payment_screenshot, content_types=types.ContentType.PHOTO)
...
@dp.message(ResultSubmission.screenshot, content_types=types.ContentType.PHOTO)
